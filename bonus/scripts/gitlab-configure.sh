create_gitlab_project() {
	gitlab-rails runner "project = Project.create( name: 'bonus_project', path: 'bonus_project', creator_id: user.id, visibility_level: 20, namespace_id: 1, organization_id: 1); project.save!; project.create_repository()"
}
